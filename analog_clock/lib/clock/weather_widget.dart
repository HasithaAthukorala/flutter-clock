...
class WeatherWidget extends StatefulWidget {
  ...
  const WeatherWidget({Key key, this.temperature, this.condition}) : super(key: key);
...
class WeatherWidgetState extends State<WeatherWidget> with SingleTickerProviderStateMixin {
